...
import { pageLimitOptions } from 'src/app/core/helpers/constant.helper';
...
@Component({
  ...
  imports: [
    ...
    CommonModule,
    MaterialModule,
    NgxPaginationModule, CustomPaginationComponent
  ],
...
export class TopicFormComponent {
  ...
  create() {
    ...
    this.spinner.show();
    this.topicService.create(this.topicForm.value, params).subscribe({
      next: (success: any) => {
        this.spinner.hide();
